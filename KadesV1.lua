--[[ 
	...
	Default hats: [ 11159410305, 11263254795, 12344545199, 13421786478, 12344591101 ]
		...
		- https://www.roblox.com/catalog/12344545199/Extra-Left-hand-moving-Blocky-whit
	...
	Author: @xyzkade 
	Discord: https://discord.gg/g2Txp9VRAJvc
	
	Credits:
		- Kade (Whole thing)
		- Emper (Little help)
		- Mizt (Inspired custom movement)

	Get the newest version in the discord.
	Settings are under the locals.
...
config.rig_name      = "FakeRig"
config.no_scripts    = true
config.set_sim_rad   = true
config.no_collisions = true
config.flinging      = false
config.preset_fling  = false
config.sex           = false
config.anti_void     = true
config.wait_time     = 0.2
config.radius_val    = 10
config.tp_radius     = 25
