...
local Window = OrionLib:MakeWindow({Name = "Burping Simulator [v1.04 GUI release]", HidePremium = false, SaveConfig = true, ConfigFolder = "Orion"})
...
InfoTab:AddParagraph("Important:","• Dropping has since been patched by Roblox, which has been removed from the Extras tab.\n• Changed Anti-AFK script to a different one.\n• Hopefully fixed a bug for the inability to auto-equip the Garlic Juice.\n• Notifications added for certain GUI actions.\n - Everything here is not final. ")
local InfoSection = InfoTab:AddSection({
	Name = "Credits"
})
